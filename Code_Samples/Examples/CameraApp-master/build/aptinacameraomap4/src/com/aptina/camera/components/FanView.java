...
import com.aptina.R;
import com.aptina.camera.interfaces.FanViewInterface;
...
public class FanView extends RelativeLayout {
	...
	private List<FanViewInterface> observers;
	 /**
     * Context
     */
    ...
    public void addListener(FanViewInterface l) {
		if(observers == null) {
			observers = new ArrayList<FanViewInterface>();
		}
		observers.add(l);
	}
	...
	private void notifyOpen() {
		if(observers != null) {
			for(FanViewInterface l : observers) {
				l.onFanViewOpen();
			}
		}
	}

...
//<--- commit and comment before work on  burstbucketview overloading methods with imageview -->
...
public abstract class ImageWorker {
    ...
    public void loadImage(Object data, String folderName, BurstBucketView burstView) {
        if (data == null) {
            return;
        }
        ImageView imageView = burstView.getImageView();
        burstView.setText(folderName);
        Bitmap bitmap = null;
...
//        	int miniThumbWidth = 20;
//            int miniThumbHeight = 20;
//            Bitmap mLastThumbnail = ThumbnailUtils.extractThumbnail(bitmap, miniThumbWidth, miniThumbHeight);
